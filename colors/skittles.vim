" Color scheme based on harlequin by Niels Madan
"
" Author: Hao Wei
" URL: github.com/weih/skittles
...
let s:label_skittles = '#e0ea18'
let s:string_skittles= '#CB4154'
let s:type_skittles= '#ab00a1'
let s:ident_skittles= '#098c90'
...
call s:HI('Label',           {'guifg': s:label_skittles})
call s:HI('Repeat',          {'guifg': s:cerise, 'gui': 'bold'})

call s:HI('Type',            {'guifg': s:type_skittles})
...
call s:HI('Identifier',      {'guifg': s:ident_skittles})
...
call s:HI('String',          {'guifg': s:string_skittles}) 
...
"*** RUBY ***
call s:HI('rubyModule',            {'guifg': s:cerise})
...
call s:HI('rubyConstant',          {'guifg': s:type_skittles})
...
call s:HI('javaScriptIdentifier',  {'guifg': s:cerise})
